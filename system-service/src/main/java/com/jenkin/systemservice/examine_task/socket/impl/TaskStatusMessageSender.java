 ...
 */
@Component(MessageSender.PREFIX+TASK_STATUS)
public class TaskStatusMessageSender implements MessageSender {
    private Logger logger = LoggerFactory.getLogger(TaskStatusMessageSender.class);
    @Override
